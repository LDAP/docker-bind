...
Automated builds of the image are available on [Dockerhub](https://hub.docker.com/r/lalber/bind) and is the recommended method of installation.

```bash
docker pull lalber/bind:latest
```

Alternatively you can build the image yourself.

```bash
docker build -t lalber/bind github.com/LDAP/docker-bind
```
